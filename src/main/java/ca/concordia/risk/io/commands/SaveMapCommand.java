...
public class SaveMapCommand implements Command {
	...
	private Map<Continent, Integer> fetchActiveContinents(GameMap p_gameMap, String[] p_names_continents) {
		
		Arrays.sort(p_names_continents); //sorts all the active Continents by ascending order (alphabetically) 
		Map<Continent, Integer> l_active_continents = new HashMap<>(); //Empty Map
	...
	private Map<Country, Integer> fetchActiveCountries(GameMap p_gameMap, String[] p_names_countries) {
